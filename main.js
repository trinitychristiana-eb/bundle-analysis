...
;// CONCATENATED MODULE: ./utils/data.json
const data_namespaceObject = JSON.parse('{"N":[{"title":"Global Navigation","analyses":[{"title":"Before Global Nav Implementation","path":"analysis/global-nav/_gn-allse-report.html"},{"title":"After Global Nav Implementation (No Treeshaking)","path":"analysis/global-nav/_gn-allse-report.html"},{"title":"Before Global Nav Implementation (Tree Shaking)","path":"analysis/global-nav/_gn-allse-report.html"}]}]}');
;// CONCATENATED MODULE: ./utils/dataManager.js


const getSections = () => data_namespaceObject.N;

/* harmony default export */ const dataManager = (getSections);

;// CONCATENATED MODULE: ./components/sectionLinks.js
...
/* harmony default export */ const components_sectionLinks = (sectionLinks);

;// CONCATENATED MODULE: ./public/main.js
// USE WITH FIREBASE AUTH
// import ViewDirectorBasedOnUserAuthStatus from '../utils/viewDirector';
 // import bootstrap elements and js



const init = () => {
  const html = components_sectionLinks();
